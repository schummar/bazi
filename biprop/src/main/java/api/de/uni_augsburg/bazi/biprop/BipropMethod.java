...
public abstract class BipropMethod
{
	public BipropOutput calculate(BipropInput input)
	{
		...
		BipropResult result = calculate(table, seats);
		return null;
	}
	...
	protected abstract BipropResult calculate(Table<BipropInput.District, String, BipropOutput.Party> table, Map<Object, Int> seats);
}
