...
public class QuotaAlgorithmPlugin implements Plugin<QuotaAlgorithm>
{
	...
	@Override public Optional<QuotaAlgorithm> tryInstantiate(Params params)
	{
		...
		switch (qs)
		{
			case "haq": q = QuotaFunction.HARE; break;
			case "hq1": q = QuotaFunction.HARE_VAR1; break;
			case "hq2": q = QuotaFunction.HARE_VAR2; break;

			case "drq": q = QuotaFunction.DROOP; break;
			case "dq1": q = QuotaFunction.DROOP_VAR1; break;
			case "dq2": q = QuotaFunction.DROOP_VAR2; break;
			case "dq3": q = QuotaFunction.DROOP_VAR3; break;
		...
		switch (rs)
		{
			case "grr": r = ResidualHandler.GREATEST_REMINDERS; break;
			case "gr1": r = ResidualHandler.GREATEST_REMAINDERS_MIN; break;
			case "wta": r = ResidualHandler.WINNER_TAKES_ALL; break;
